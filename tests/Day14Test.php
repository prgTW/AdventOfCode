...
use prgTW\AdventOfCode2020\Impl\Day14;

class Day14Test extends TestCase
{
	public function testPart1TestInput(): void
	{
		$class = new Day14(__DIR__.'/fixtures/day14/day14_1.txt');
	...
	{
		$class = new Day14(__DIR__.'/../input/day14.txt');
		self::assertSame(17028179706934, $class->part1());
	}

	public function testPart2TestInput(): void
	{
		$class = new Day14(__DIR__.'/fixtures/day14/day14_2.txt');
