...
use prgTW\AdventOfCode\Impl\Year2020\Day13;

class Day13Test extends TestCase
{
    public function testPart1TestInput(): void
    {
        $class = new Day13(__DIR__.'/../fixtures/2020/day13/day13_1.txt');
    ...
    {
        $class = new Day13(__DIR__.'/../../input/2020/day13.txt');
    ...
    public static function providePart2TestInputs(): iterable
    {
        return [
            [__DIR__.'/../fixtures/2020/day13/day13_1.txt', 1068781],
            [__DIR__.'/../fixtures/2020/day13/day13_2.txt', 3417],
            [__DIR__.'/../fixtures/2020/day13/day13_3.txt', 754018],
            [__DIR__.'/../fixtures/2020/day13/day13_4.txt', 779210],
            [__DIR__.'/../fixtures/2020/day13/day13_5.txt', 1261476],
            [__DIR__.'/../fixtures/2020/day13/day13_6.txt', 1202161486],
        ];
    }
