...
use prgTW\AdventOfCode\Impl\Tools\Day11\FirstVisibleAdjacencyStrategy;
...
class NearestAdjacencyStrategyTest extends TestCase
{
    ...
    public static function provideGetAdjacentSeatsInputs(): iterable
    {
        return [
            ...
            [__DIR__.'/../../fixtures/2020/day11/day11_part2_2.txt', 1, 1, Seat::EMPTY, 1],
            [__DIR__.'/../../fixtures/2020/day11/day11_part2_3.txt', 3, 3, Seat::OCCUPIED, 0],
        ];
    }
